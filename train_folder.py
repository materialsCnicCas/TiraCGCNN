...
parser.add_argument(
    ...
    default="data/3k/config_example.json",
...
parser.add_argument(
    "--output_dir", default="output/", help="Folder to save outputs",
)
...
def train_for_folder(
    ...
    f = open(os.path.join(config.output_dir, "time.csv"), "w", )
    f.write("Time:" + str(t2 - t1) + "s")
    f.close()
...
# torchrun --nproc_per_node=8 train_folder.py